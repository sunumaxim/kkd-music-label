...
import {
  ...
  Menu, X, ChevronRight, UploadCloud, Mail, Share2, Megaphone, Image as ImageIcon, Wallet, Ticket, Mic, Scissors
} from 'lucide-react';
...
const navGroups = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Bannières & Annonces', path: '/admin/promo-banners', icon: ImageIcon },
