...
import { Ticket, Loader2, Clock, Upload, Check, LogIn, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="bg-gradient-to-br from-primary/10 to-card border border-primary/30 rounded-2xl p-5 space-y-4">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        {me ? (
          <a href={WAVE_PAY_LINK} target="_blank" rel="noreferrer" onClick={() => setStep('confirm')}
      ...
      <p className="text-[11px] text-muted-foreground leading-relaxed">
        Paiement via Wave ({WAVE_MERCHANT}). Lecture sur KKD uniquement. Commission KKD : 10 %.
      </p>
    </div>
  );
}